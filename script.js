...
const keyboardInit = (localIndex) => {
  const keyLayouts = {
    ...
    eng: [
      ...
      { text: 'CapsLock', code: 20 }, { text: 'a', code: 65 }, { text: 's', code: 83 }, { text: 'd', code: 68 },
    ...
    rus: [
      ...
      { text: 'CapsLock', code: 20 }, { text: 'ф', code: 65 }, { text: 'ы', code: 83 }, { text: 'в', code: 68 },
    ...
    // event.preventDefault()
      ...
      arrKey.forEach((key) => {
        ...
        if (which.toString() === id || code === id) {
          ...
          if (id === 'CapsLock' || id === 'ShiftLeft' || id === 'ShiftRirht') {
            // eslint-disable-next-line
